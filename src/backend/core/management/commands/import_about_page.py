...
JSON_PATH = "/mnt/c/Users/Maxim/Downloads/about_page_content.json"
PLACEHOLDER = "placeholder.png"


class Command(BaseCommand):
    help = "Import About Us page content from JSON"

    def handle(self, *args, **options):
        with open(JSON_PATH, encoding="utf-8") as f:
            data = json.load(f)

        page_data = data["about_page"]

        page, created = Page.objects.get_or_create(
            slug="despre-noi",
            defaults={"id": uuid.uuid4()},
        )
        page.name_ro = "Despre Noi"
        page.name_en = "About Us"
        page.name_ru = "О нас"
        ...
        self.stdout.write(self.style.SUCCESS(f"Imported About Us page (slug: {page.slug})"))
